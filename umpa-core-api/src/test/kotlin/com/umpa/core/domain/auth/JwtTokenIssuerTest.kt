...
internal class JwtTokenIssuerTest {
    ...
    @BeforeEach
    fun setup() {
        key = Keys.hmacShaKeyFor(Decoders.BASE64.decode("fnafpemfkfofnafpemfkfofnafpemfkfofdsldfknasdlfnlas"))
    ...
    fun `토큰을 decode 했을 때 올바른 body를 얻는다`() {
        val actual = sut.decode(
            "eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjEsImlhdCI6MTY4OTQ0MzQzMCwiZXhwIjoxNjg5NTI5ODMwfQ.fM2glagAXVAd91TFQcfO-tXgumb8oy_NeVAR3_jHovk"
        )

...
enum class ErrorType(val statusCode: HttpStatus, val errorCode: ErrorCode, val message: String) {
    ...
    FORBIDDEN_FOLLOW(HttpStatus.FORBIDDEN, ErrorCode.E4035, "해당 유저를 팔로우할 수 없습니다."),
    FORBIDDEN_UNFOLLOW(HttpStatus.FORBIDDEN, ErrorCode.E4036, "해당 유저를 팔로우 취소할 수 없습니다."),
    ...
    NOT_FOUND_USER(HttpStatus.NOT_FOUND, ErrorCode.E4043, "해당 유저를 찾을 수 없습니다.")
}
